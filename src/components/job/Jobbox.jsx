...
const Jobbox = ({ data }) => {
  ...
  return (
    <div className="rounded-xl shadow-sm p-6 w-full max-w-md mx-auto border border-gray-200 hover:shadow-md transition duration-200">
      {/* Job Title & Category */}
      ...
      {/* Apply Button */}
     <a
      href={`/application/${data._id}`} // assuming each job has a unique `_id`
